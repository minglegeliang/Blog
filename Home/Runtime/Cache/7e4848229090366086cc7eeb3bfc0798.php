...
<body>
	<div class="navbar navbar-default navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar">
				...
				<form action="__URL__/search" class="navbar-form navbar-right" role="search" name="myForm">
					<div class="form-group">
						<input type="text" name="kw" class="form-control" placeholder="关键字" />
					</div>
					<input type="button" class="btn btn-default" onclick="sub()" value="搜索"/>
				</form>
	...
	<?php if(is_array($data)): foreach($data as $key=>$d): ?><div class="page-header">
			<h2><a href="__URL__/content/id/<?php echo ($d["id"]); ?>">标题：<?php echo ($d["title"]); ?></a></h2>
		</div>
		<div class="panel">
			<div class="panel-body">内容：<pre><h3><?php echo ($d["content"]); ?></h3></pre></div>
	...
	<div class="col-md-3 blog-container-sidebar" id="sidebar">
	    ...
	    <?php if(is_array($lists)): foreach($lists as $key=>$l): ?><div class="list-group" id="category">
