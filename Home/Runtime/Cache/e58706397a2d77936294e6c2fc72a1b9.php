...
<body>
	...
	<form action="__URL__/doChange/id/<?php echo ($blog["id"]); ?>" method="POST" name="myForm">
		标题：<input type="text" name="title" value="<?php echo ($blog["title"]); ?>"><br><br>
		分类：<select name="type" >
		...
		<input type="button" value="修改"  class="submit" onclick="sub()"><br><br><br><br>
	</form>
